...
\begin{figure}[t]
\centering\includegraphics[width=.8\textwidth]{fig/hpctoolkit-code-centric.png}
...
\begin{figure}[t]
\centering\includegraphics[width=.8\textwidth]{fig/hpctoolkit-thread-centric.png}
...
\begin{figure}[t]
\centering\includegraphics[width=.8\textwidth]{fig/hpctoolkit-time-centric.png}
...
\begin{figure}[t]
\centering\includegraphics[width=.8\textwidth]{fig/hpctoolkit-gpu-workflow.svg}
...
\begin{figure}[t]
\centering\includegraphics[width=1.0\textwidth]{fig/cycles-per-inst.png}
...
\begin{figure}[t]
\centering\includegraphics[width=1.0\textwidth]{fig/cycles-per-inst-2.png}
%Two possible representations for the call path fragment $\ldots s_1 \rightarrow s_2 \ldots$, where $s_1$ and $s_2$ are call sites and where $s_1$ represents a call from $p$ to $q$ and $s_2$ a call from $q'$ to $r$.
...
\begin{figure}[t]
\centering\includegraphics[width=1.0\textwidth]{fig/fpwaste.png}
%Two possible representations for the call path fragment $\ldots s_1 \rightarrow s_2 \ldots$, where $s_1$ and $s_2$ are call sites and where $s_1$ represents a call from $p$ to $q$ and $s_2$ a call from $q'$ to $r$.
...
\begin{figure}[t]
\centering\includegraphics[width=1.0\textwidth]{fig/fp-efficiency.png}
%Two possible representations for the call path fragment $\ldots s_1 \rightarrow s_2 \ldots$, where $s_1$ and $s_2$ are call sites and where $s_1$ represents a call from $p$ to $q$ and $s_2$ a call from $q'$ to $r$.
...
\begin{figure}[t]
\centering\includegraphics[width=1.0\textwidth]{fig/fp-efficiency-loop.png}
%Two possible representations for the call path fragment $\ldots s_1 \rightarrow s_2 \ldots$, where $s_1$ and $s_2$ are call sites and where $s_1$ represents a call from $p$ to $q$ and $s_2$ a call from $q'$ to $r$.
...
\begin{figure}[t]
\centering\includegraphics[width=1.0\textwidth]{fig/flash-scalability.png}
%Two possible representations for the call path fragment $\ldots s_1 \rightarrow s_2 \ldots$, where $s_1$ and $s_2$ are call sites and where $s_1$ represents a call from $p$ to $q$ and $s_2$ a call from $q'$ to $r$.
...
\begin{figure}[t]
\centering\includegraphics[width=1.0\textwidth]{fig/scaling-loss-2.png}
%Two possible representations for the call path fragment $\ldots s_1 \rightarrow s_2 \ldots$, where $s_1$ and $s_2$ are call sites and where $s_1$ represents a call from $p$ to $q$ and $s_2$ a call from $q'$ to $r$.
